  ...
  return (
    <div className="about">
      ...
      <div className="collapses">
        <Collapse
          extraClass="collapse-about"
          title="Fiabilité"
          content="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiés par nos équipes."
        />
        <Collapse
          extraClass="collapse-about"
          title="Respect"
